        ...
        <div className="container">
          <div className="legal-content">
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第1条（適用）</h2>
              <p>
                本規約は、株式会社SENRITSU（以下「当社」といいます）が提供するAI×プログラミングサロン（以下「本サービス」といいます）の利用に関する条件を定めるものです。
              </p>
              <p>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第2条（利用登録）</h2>
              <ol>
                <li>本サービスの利用を希望する方は、本規約に同意の上、当社の定める方法によって利用登録を申請し、当社がこれを承認することで、利用登録が完了します。</li>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第3条（ユーザーIDおよびパスワードの管理）</h2>
              <ol>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第4条（利用料金および支払方法）</h2>
              <ol>
                <li>ユーザーは、本サービスの有料プランの対価として、当社が別途定める利用料金を、当社が指定する方法により支払うものとします。</li>
                <li>ユーザーが利用料金の支払を遅滞した場合には、ユーザーは年14.6％の割合による遅延損害金を支払うものとします。</li>
                <li>月額課金の場合、当月中に退会・解約の手続きをされても、日割り計算による返金は行いません。</li>
              </ol>
            </section>

            <section className="legal-section">
              <h2 className="gradient-text">第5条（禁止事項）</h2>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第6条（本サービスの提供の停止等）</h2>
              <ol>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第7条（著作権）</h2>
              <ol>
                <li>本サービスによって提供される教材、コンテンツ、情報等に関する著作権は、当社または当社にライセンスを許諾している者に帰属します。</li>
                <li>ユーザーは、本サービスを通じて得た情報を、当社の事前の書面による承諾なく、複製、譲渡、貸与、翻訳、改変、転載、公衆送信（送信可能化を含みます）、伝送、配布、出版、営業使用等をしてはならないものとします。</li>
              </ol>
            </section>

            <section className="legal-section">
              <h2 className="gradient-text">第8条（利用制限および登録抹消）</h2>
              <ol>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第9条（退会）</h2>
              <p>
                ユーザーは、当社の定める退会手続により、本サービスから退会できるものとします。
                退会後も、当社に対する債務がある場合は、その債務を免れることはできません。
              </p>
            </section>

            <section className="legal-section">
              <h2 className="gradient-text">第10条（保証の否認および免責事項）</h2>
              <ol>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第11条（サービス内容の変更等）</h2>
              <p>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第12条（利用規約の変更）</h2>
              <p>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第13条（個人情報の取扱い）</h2>
              <p>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第14条（通知または連絡）</h2>
              <p>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第15条（権利義務の譲渡の禁止）</h2>
              <p>
            ...
            <section className="legal-section">
              <h2 className="gradient-text">第16条（準拠法・裁判管轄）</h2>
              <ol>
            ...
            <div className="legal-footer">
              <p>制定日：2025年1月1日</p>
              <p>最終更新日：2025年1月1日</p>
              <p className="company-info">株式会社SENRITSU</p>
            </div>
          </div>
        </div>
      </main>
